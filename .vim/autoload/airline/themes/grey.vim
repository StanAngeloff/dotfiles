...
let g:airline#themes#grey#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#grey#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
